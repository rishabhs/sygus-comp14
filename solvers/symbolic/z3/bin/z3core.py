#Embedded file name: src/api/python/z3core.py
import sys, os
import ctypes
from z3types import *
...
def init(PATH):
    ...
    _lib.Z3_params_set_bool.argtypes = [ContextObj,
     Params,
     Symbol,
     ctypes.c_bool]
    _lib.Z3_params_set_uint.argtypes = [ContextObj,
     Params,
     Symbol,
     ctypes.c_uint]
    _lib.Z3_params_set_double.argtypes = [ContextObj,
     Params,
     Symbol,
     ctypes.c_double]
    _lib.Z3_params_set_symbol.argtypes = [ContextObj,
     Params,
     Symbol,
     Symbol]
    ...
    _lib.Z3_mk_tuple_sort.argtypes = [ContextObj,
     Symbol,
     ctypes.c_uint,
    ...
    _lib.Z3_mk_enumeration_sort.argtypes = [ContextObj,
     Symbol,
     ctypes.c_uint,
     ctypes.POINTER(Symbol),
     ctypes.POINTER(FuncDecl),
    ...
    _lib.Z3_mk_list_sort.argtypes = [ContextObj,
     Symbol,
     Sort,
     ctypes.POINTER(FuncDecl),
     ctypes.POINTER(FuncDecl),
    ...
    _lib.Z3_mk_constructor.argtypes = [ContextObj,
     Symbol,
     Symbol,
     ctypes.c_uint,
     ctypes.POINTER(Symbol),
    ...
    _lib.Z3_mk_datatype.argtypes = [ContextObj,
     Symbol,
     ctypes.c_uint,
     ctypes.POINTER(Constructor)]
    ...
    _lib.Z3_mk_datatypes.argtypes = [ContextObj,
     ctypes.c_uint,
     ctypes.POINTER(Symbol),
     ctypes.POINTER(Sort),
     ctypes.POINTER(ConstructorList)]
    _lib.Z3_query_constructor.argtypes = [ContextObj,
     Constructor,
     ctypes.c_uint,
     ctypes.POINTER(FuncDecl),
     ctypes.POINTER(FuncDecl),
    ...
    _lib.Z3_mk_func_decl.argtypes = [ContextObj,
     Symbol,
     ctypes.c_uint,
     ctypes.POINTER(Sort),
     Sort]
    _lib.Z3_mk_app.restype = Ast
    _lib.Z3_mk_app.argtypes = [ContextObj,
     FuncDecl,
     ctypes.c_uint,
     ctypes.POINTER(Ast)]
    ...
    _lib.Z3_mk_fresh_func_decl.argtypes = [ContextObj,
     ctypes.c_char_p,
     ctypes.c_uint,
     ctypes.POINTER(Sort),
     Sort]
    ...
    _lib.Z3_mk_ite.argtypes = [ContextObj,
     Ast,
     Ast,
     Ast]
    ...
    _lib.Z3_mk_extract.argtypes = [ContextObj,
     ctypes.c_uint,
     ctypes.c_uint,
     Ast]
    ...
    _lib.Z3_mk_bvadd_no_overflow.argtypes = [ContextObj,
     Ast,
     Ast,
     ctypes.c_bool]
    ...
    _lib.Z3_mk_bvsub_no_underflow.argtypes = [ContextObj,
     Ast,
     Ast,
     ctypes.c_bool]
    ...
    _lib.Z3_mk_bvmul_no_overflow.argtypes = [ContextObj,
     Ast,
     Ast,
     ctypes.c_bool]
    ...
    _lib.Z3_mk_store.argtypes = [ContextObj,
     Ast,
     Ast,
     Ast]
    ...
    _lib.Z3_mk_map.argtypes = [ContextObj,
     FuncDecl,
     ctypes.c_uint,
     ctypes.POINTER(Ast)]
    ...
    _lib.Z3_mk_forall.argtypes = [ContextObj,
     ctypes.c_uint,
     ctypes.c_uint,
     ctypes.POINTER(Pattern),
     ctypes.c_uint,
     ctypes.POINTER(Sort),
     ctypes.POINTER(Symbol),
     Ast]
    _lib.Z3_mk_exists.restype = Ast
    _lib.Z3_mk_exists.argtypes = [ContextObj,
     ctypes.c_uint,
     ctypes.c_uint,
     ctypes.POINTER(Pattern),
     ctypes.c_uint,
    ...
    _lib.Z3_mk_quantifier.argtypes = [ContextObj,
     ctypes.c_bool,
     ctypes.c_uint,
     ctypes.c_uint,
     ctypes.POINTER(Pattern),
    ...
    _lib.Z3_mk_quantifier_ex.argtypes = [ContextObj,
     ctypes.c_bool,
     ctypes.c_uint,
     Symbol,
     Symbol,
    ...
    _lib.Z3_mk_forall_const.argtypes = [ContextObj,
     ctypes.c_uint,
     ctypes.c_uint,
     ctypes.POINTER(Ast),
     ctypes.c_uint,
    ...
    _lib.Z3_mk_exists_const.argtypes = [ContextObj,
     ctypes.c_uint,
     ctypes.c_uint,
     ctypes.POINTER(Ast),
     ctypes.c_uint,
    ...
    _lib.Z3_mk_quantifier_const.argtypes = [ContextObj,
     ctypes.c_bool,
     ctypes.c_uint,
     ctypes.c_uint,
     ctypes.POINTER(Ast),
    ...
    _lib.Z3_mk_quantifier_const_ex.argtypes = [ContextObj,
     ctypes.c_bool,
     ctypes.c_uint,
     Symbol,
     Symbol,
    ...
    _lib.Z3_get_datatype_sort_constructor_accessor.argtypes = [ContextObj,
     Sort,
     ctypes.c_uint,
     ctypes.c_uint]
    ...
    _lib.Z3_get_numeral_small.argtypes = [ContextObj,
     Ast,
    ...
    _lib.Z3_get_numeral_rational_int64.argtypes = [ContextObj,
     Ast,
     ctypes.POINTER(ctypes.c_longlong),
     ctypes.POINTER(ctypes.c_longlong)]
    ...
    _lib.Z3_update_term.argtypes = [ContextObj,
     Ast,
     ctypes.c_uint,
     ctypes.POINTER(Ast)]
    _lib.Z3_substitute.restype = Ast
    _lib.Z3_substitute.argtypes = [ContextObj,
     Ast,
     ctypes.c_uint,
     ctypes.POINTER(Ast),
     ctypes.POINTER(Ast)]
    _lib.Z3_substitute_vars.restype = Ast
    _lib.Z3_substitute_vars.argtypes = [ContextObj,
     Ast,
     ctypes.c_uint,
     ctypes.POINTER(Ast)]
    ...
    _lib.Z3_model_eval.argtypes = [ContextObj,
     Model,
     Ast,
     ctypes.c_bool,
     ctypes.POINTER(Ast)]
    ...
    _lib.Z3_benchmark_to_smtlib_string.argtypes = [ContextObj,
     ctypes.c_char_p,
     ctypes.c_char_p,
     ctypes.c_char_p,
     ctypes.c_char_p,
    ...
    _lib.Z3_parse_smtlib2_string.argtypes = [ContextObj,
     ctypes.c_char_p,
     ctypes.c_uint,
     ctypes.POINTER(Symbol),
     ctypes.POINTER(Sort),
    ...
    _lib.Z3_parse_smtlib2_file.argtypes = [ContextObj,
     ctypes.c_char_p,
     ctypes.c_uint,
     ctypes.POINTER(Symbol),
     ctypes.POINTER(Sort),
    ...
    _lib.Z3_parse_smtlib_string.argtypes = [ContextObj,
     ...
     ctypes.POINTER(Symbol),
     ctypes.POINTER(FuncDecl)]
    _lib.Z3_parse_smtlib_file.argtypes = [ContextObj,
     ctypes.c_char_p,
     ctypes.c_uint,
     ctypes.POINTER(Symbol),
     ctypes.POINTER(Sort),
    ...
    _lib.Z3_get_version.argtypes = [ctypes.POINTER(ctypes.c_uint),
     ctypes.POINTER(ctypes.c_uint),
     ctypes.POINTER(ctypes.c_uint),
     ctypes.POINTER(ctypes.c_uint)]
    ...
    _lib.Z3_fixedpoint_add_rule.argtypes = [ContextObj,
     FixedpointObj,
     Ast,
     Symbol]
    _lib.Z3_fixedpoint_add_fact.argtypes = [ContextObj,
     FixedpointObj,
     FuncDecl,
     ctypes.c_uint,
     ctypes.POINTER(ctypes.c_uint)]
    ...
    _lib.Z3_fixedpoint_query_relations.argtypes = [ContextObj,
     FixedpointObj,
     ctypes.c_uint,
     ctypes.POINTER(FuncDecl)]
    ...
    _lib.Z3_fixedpoint_update_rule.argtypes = [ContextObj,
     FixedpointObj,
     Ast,
     Symbol]
    ...
    _lib.Z3_fixedpoint_get_cover_delta.argtypes = [ContextObj,
     FixedpointObj,
     ctypes.c_int,
     FuncDecl]
    _lib.Z3_fixedpoint_add_cover.argtypes = [ContextObj,
     FixedpointObj,
     ctypes.c_int,
     FuncDecl,
     Ast]
    ...
    _lib.Z3_fixedpoint_set_predicate_representation.argtypes = [ContextObj,
     FixedpointObj,
     FuncDecl,
     ctypes.c_uint,
     ctypes.POINTER(Symbol)]
    ...
    _lib.Z3_fixedpoint_to_string.argtypes = [ContextObj,
     FixedpointObj,
     ctypes.c_uint,
     ctypes.POINTER(Ast)]
    ...
    _lib.Z3_ast_vector_set.argtypes = [ContextObj,
     AstVectorObj,
     ctypes.c_uint,
     Ast]
    ...
    _lib.Z3_ast_map_insert.argtypes = [ContextObj,
     AstMapObj,
     Ast,
     Ast]
    ...
    _lib.Z3_mk_goal.argtypes = [ContextObj,
     ctypes.c_bool,
     ctypes.c_bool,
     ctypes.c_bool]
    ...
    _lib.Z3_tactic_cond.argtypes = [ContextObj,
     ProbeObj,
     TacticObj,
     TacticObj]
    ...
    _lib.Z3_tactic_apply_ex.argtypes = [ContextObj,
     TacticObj,
     GoalObj,
     Params]
    ...
    _lib.Z3_apply_result_convert_model.argtypes = [ContextObj,
     ApplyResultObj,
     ctypes.c_uint,
     Model]
    ...
    _lib.Z3_solver_assert_and_track.argtypes = [ContextObj,
     SolverObj,
     Ast,
     Ast]
    ...
    _lib.Z3_mk_injective_function.argtypes = [ContextObj,
     Symbol,
     ctypes.c_uint,
     ctypes.POINTER(Sort),
     Sort]
    ...
    _lib.Z3_get_implied_equalities.argtypes = [ContextObj,
     SolverObj,
     ctypes.c_uint,
     ctypes.POINTER(Ast),
     ctypes.POINTER(ctypes.c_uint)]
    ...
    _lib.Z3_mk_label.argtypes = [ContextObj,
     Symbol,
     ctypes.c_bool,
     Ast]
    ...
    _lib.Z3_eval_func_decl.argtypes = [ContextObj,
     Model,
     FuncDecl,
     ctypes.POINTER(Ast)]
    _lib.Z3_is_array_value.restype = ctypes.c_bool
    _lib.Z3_is_array_value.argtypes = [ContextObj,
     Model,
     Ast,
     ctypes.POINTER(ctypes.c_uint)]
    _lib.Z3_get_array_value.argtypes = [ContextObj,
     Model,
     Ast,
     ctypes.c_uint,
     ctypes.POINTER(Ast),
    ...
    _lib.Z3_get_model_func_entry_num_args.argtypes = [ContextObj,
     Model,
     ctypes.c_uint,
     ctypes.c_uint]
    _lib.Z3_get_model_func_entry_arg.restype = Ast
    _lib.Z3_get_model_func_entry_arg.argtypes = [ContextObj,
     Model,
     ctypes.c_uint,
     ctypes.c_uint,
     ctypes.c_uint]
    _lib.Z3_get_model_func_entry_value.restype = Ast
    _lib.Z3_get_model_func_entry_value.argtypes = [ContextObj,
     Model,
     ctypes.c_uint,
     ctypes.c_uint]
    _lib.Z3_eval.restype = ctypes.c_bool
    _lib.Z3_eval.argtypes = [ContextObj,
     Model,
     Ast,
     ctypes.POINTER(Ast)]
    _lib.Z3_eval_decl.restype = ctypes.c_bool
    _lib.Z3_eval_decl.argtypes = [ContextObj,
     Model,
     FuncDecl,
     ctypes.c_uint,
     ctypes.POINTER(Ast),
    ...
    _lib.Z3_algebraic_roots.argtypes = [ContextObj,
     Ast,
     ctypes.c_uint,
     ctypes.POINTER(Ast)]
    _lib.Z3_algebraic_eval.restype = ctypes.c_int
    _lib.Z3_algebraic_eval.argtypes = [ContextObj,
     Ast,
     ctypes.c_uint,
     ctypes.POINTER(Ast)]
    _lib.Z3_polynomial_subresultants.restype = AstVectorObj
    _lib.Z3_polynomial_subresultants.argtypes = [ContextObj,
     Ast,
     Ast,
     Ast]
    ...
    _lib.Z3_rcf_mk_roots.argtypes = [ContextObj,
     ctypes.c_uint,
    ...
    _lib.Z3_rcf_num_to_string.argtypes = [ContextObj,
     RCFNumObj,
     ctypes.c_bool,
     ctypes.c_bool]
    ...
    _lib.Z3_rcf_get_numerator_denominator.argtypes = [ContextObj,
     RCFNumObj,
     ctypes.POINTER(RCFNumObj),
     ctypes.POINTER(RCFNumObj)]
