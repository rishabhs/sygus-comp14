#Embedded file name: src/api/python/z3printer.py
import sys, io, z3
from z3consts import *
from z3core import *
_z3_op_to_str = {Z3_OP_TRUE: 'True',
 Z3_OP_FALSE: 'False',
 Z3_OP_EQ: '==',
...
_z3_pre_html_op_to_str = {Z3_OP_EQ: '=',
 Z3_OP_IFF: '=',
 Z3_OP_NOT: '&not;',
 Z3_OP_AND: '&and;',
 Z3_OP_OR: '&or;',
...
_z3_pre_html_precedence = {Z3_OP_BUDIV: 2,
 Z3_OP_BUREM: 2,
 Z3_OP_BLSHR: 4,
 Z3_OP_ULEQ: 8,
 Z3_OP_ULT: 8,
...
def seq1(header, args, lp = '(', rp = ')'):
    return group(compose(to_format(header), to_format(lp), indent(len(lp) + _len(header), seq(args)), to_format(rp)))
