...
void register_z3_replayer_cmds(z3_replayer & in) {
  ...
  in.register_cmd(291, exec_Z3_get_error_code);
  in.register_cmd(292, exec_Z3_set_error);
  in.register_cmd(293, exec_Z3_get_error_msg);
  in.register_cmd(294, exec_Z3_get_error_msg_ex);
  in.register_cmd(295, exec_Z3_get_version);
  in.register_cmd(296, exec_Z3_enable_trace);
  in.register_cmd(297, exec_Z3_disable_trace);
  ...
  in.register_cmd(418, exec_Z3_solver_assert_and_track);
  in.register_cmd(419, exec_Z3_solver_get_assertions);
  in.register_cmd(420, exec_Z3_solver_check);
  in.register_cmd(421, exec_Z3_solver_check_assumptions);
  in.register_cmd(422, exec_Z3_solver_get_model);
  in.register_cmd(423, exec_Z3_solver_get_proof);
  in.register_cmd(424, exec_Z3_solver_get_unsat_core);
  in.register_cmd(425, exec_Z3_solver_get_reason_unknown);
  in.register_cmd(426, exec_Z3_solver_get_statistics);
  in.register_cmd(427, exec_Z3_solver_to_string);
  in.register_cmd(428, exec_Z3_stats_to_string);
  in.register_cmd(429, exec_Z3_stats_inc_ref);
  in.register_cmd(430, exec_Z3_stats_dec_ref);
  in.register_cmd(431, exec_Z3_stats_size);
  in.register_cmd(432, exec_Z3_stats_get_key);
  in.register_cmd(433, exec_Z3_stats_is_uint);
  in.register_cmd(434, exec_Z3_stats_is_double);
  in.register_cmd(435, exec_Z3_stats_get_uint_value);
  in.register_cmd(436, exec_Z3_stats_get_double_value);
  in.register_cmd(437, exec_Z3_mk_injective_function);
  in.register_cmd(438, exec_Z3_set_logic);
  in.register_cmd(439, exec_Z3_push);
  in.register_cmd(440, exec_Z3_pop);
  in.register_cmd(441, exec_Z3_get_num_scopes);
  in.register_cmd(442, exec_Z3_persist_ast);
  in.register_cmd(443, exec_Z3_assert_cnstr);
  in.register_cmd(444, exec_Z3_check_and_get_model);
  in.register_cmd(445, exec_Z3_check);
  in.register_cmd(446, exec_Z3_check_assumptions);
  in.register_cmd(447, exec_Z3_get_implied_equalities);
  in.register_cmd(448, exec_Z3_del_model);
  in.register_cmd(449, exec_Z3_soft_check_cancel);
  in.register_cmd(450, exec_Z3_get_search_failure);
  in.register_cmd(451, exec_Z3_mk_label);
  in.register_cmd(452, exec_Z3_get_relevant_labels);
  in.register_cmd(453, exec_Z3_get_relevant_literals);
  in.register_cmd(454, exec_Z3_get_guessed_literals);
  in.register_cmd(455, exec_Z3_del_literals);
  in.register_cmd(456, exec_Z3_get_num_literals);
  in.register_cmd(457, exec_Z3_get_label_symbol);
  in.register_cmd(458, exec_Z3_get_literal);
  in.register_cmd(459, exec_Z3_disable_literal);
  in.register_cmd(460, exec_Z3_block_literals);
  in.register_cmd(461, exec_Z3_get_model_num_constants);
  in.register_cmd(462, exec_Z3_get_model_constant);
  in.register_cmd(463, exec_Z3_get_model_num_funcs);
  in.register_cmd(464, exec_Z3_get_model_func_decl);
  in.register_cmd(465, exec_Z3_eval_func_decl);
  in.register_cmd(466, exec_Z3_is_array_value);
  in.register_cmd(467, exec_Z3_get_array_value);
  in.register_cmd(468, exec_Z3_get_model_func_else);
  in.register_cmd(469, exec_Z3_get_model_func_num_entries);
  in.register_cmd(470, exec_Z3_get_model_func_entry_num_args);
  in.register_cmd(471, exec_Z3_get_model_func_entry_arg);
  in.register_cmd(472, exec_Z3_get_model_func_entry_value);
  in.register_cmd(473, exec_Z3_eval);
  in.register_cmd(474, exec_Z3_eval_decl);
  in.register_cmd(475, exec_Z3_context_to_string);
  in.register_cmd(476, exec_Z3_statistics_to_string);
  in.register_cmd(477, exec_Z3_get_context_assignment);
}
